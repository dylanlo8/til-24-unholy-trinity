...
# from transformers import BertForQuestionAnswering, AutoTokenizer, Trainer, BertTokenizer, BertForSequenceClassification
import torch
...
class NLPManager:
    def __init__(self):
        ...
        # model_path = "petrichoro7/BERTModel"
...
#     inputs = "tool to deploy is big, and black nuclear bombs, target is yellow, pink pokka-dotted fisher fighter jet, heading is sevenin niner throne,."
